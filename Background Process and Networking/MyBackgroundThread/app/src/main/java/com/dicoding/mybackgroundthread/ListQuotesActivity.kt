...
import com.dicoding.mybackgroundthread.databinding.ActivityListQuotesBinding
  ...
  private fun getListQuotes() {
    ...
    client.get(url, object : AsyncHttpResponseHandler() {
      override fun onSuccess(
        ...
        try {
          /*
             karena pada JSON https://www.dicoding.com/academies/14/tutorials/6514
             dimulai dengan [] artinya JSON bertipe JSONArray
          */
